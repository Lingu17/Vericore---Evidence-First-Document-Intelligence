...
export const UnknownQuestionCard: React.FC<UnknownQuestionCardProps> = ({
  ...
  return (
    <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-5 shadow-card space-y-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            {message.suggested_followups.map((s, idx) => (
              <button
                ...
                className="text-xs text-brand-700 bg-white hover:bg-brand-50 border border-slate-200 hover:border-brand-300 px-2.5 py-1 rounded-md shadow-subtle hover:shadow-card transition-all duration-200 hover:-translate-y-px text-left flex items-center gap-1"
              >
