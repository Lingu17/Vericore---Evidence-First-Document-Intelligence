    ...
    <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-card space-y-3.5">
      ...
      <div className="flex items-start justify-between gap-2 border-b border-slate-200 pb-3">
        <div className="flex items-center gap-2 min-w-0">
          <div className="p-1.5 rounded-lg bg-brand-50 text-brand-600 border border-brand-200 shrink-0">
            <FileText className="w-4 h-4" />
          </div>
          <div className="min-w-0">
            <h4 className="text-xs font-bold text-slate-800 truncate" title={evidence.filename}>
              {evidence.filename}
            </h4>
      ...
      {/* Section info */}
      {evidence.section && (
        <div className="flex items-center gap-1.5 text-xs font-medium text-slate-700 bg-slate-50 px-2.5 py-1.5 rounded-md border border-slate-200">
      ...
      <div className="space-y-1.5">
        ...
        <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-800 leading-relaxed font-mono whitespace-pre-line selection:bg-brand-100 selection:text-brand-900">
          {evidence.evidence}
        </div>
      </div>
