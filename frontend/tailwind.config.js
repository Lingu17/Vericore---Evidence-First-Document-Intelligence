  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'lift': '0 12px 24px -8px rgba(15, 23, 42, 0.14), 0 4px 8px -4px rgba(15, 23, 42, 0.08)',
        'float': '0 20px 48px -16px rgba(15, 23, 42, 0.18), 0 8px 16px -8px rgba(15, 23, 42, 0.10)',
        'glow-blue': '0 12px 28px -8px rgba(37, 99, 235, 0.22), 0 4px 8px -4px rgba(37, 99, 235, 0.12)',
      }
    },
  },
  plugins: [],
